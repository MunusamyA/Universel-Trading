...
function listDailyLedgerReport(PDO $pdo)
{
    ...
    $entryType = cleanInput($_GET['entry_type'] ?? 'all');
    ...
    $allowedTypes = ['all', 'sales', 'customer_payment', 'purchase', 'supplier_payment', 'expense'];
