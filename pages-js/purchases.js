        ...
        $.each(rows, function (index, row) {
            html += `
                <tr>
                    <td>${index + 1}</td>
                    <td>
                        <h6 class="mb-0">${escapeHtml(row.bill_no || '')}</h6>
                    ...
                    <td>
                        <div class="btn-group btn-group-sm">
                            <a href="${window.BASE_URL}pages/purchase-form.php?id=${row.id}" class="btn btn-outline-primary" title="Edit">
                                <i class="mdi mdi-pencil"></i>
                            </a>
                            <button type="button" class="btn btn-outline-danger delete-purchase-btn" data-id="${row.id}" title="Delete">
