            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div>
                                <h4 class="mb-0" id="pageTitleText">Customer Ledger</h4>
                                <small class="text-muted" id="pageNoteText">Debit / Credit / Balance statement</small>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="card-body text-muted">
                                <h3 class="text-primary" id="ledgerEntriesCount">0</h3>
                                Total Entries
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="card-body text-muted">
                                <h3 class="text-danger" id="ledgerDebitTotal">₹0.00</h3>
                                Total Debit
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="card-body text-muted">
                                <h3 class="text-success" id="ledgerCreditTotal">₹0.00</h3>
                                Total Credit
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="card-body text-muted">
                                <h3 class="text-warning" id="ledgerClosingBalance">₹0.00</h3>
                                Closing Balance
                            </div>
                        </div>
                    </div>
