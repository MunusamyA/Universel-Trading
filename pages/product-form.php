...
<div class="col-md-4"><label class="form-label">Sub Category</label><div class="input-group"><select class="form-select" id="sub_category_id" name="sub_category_id"><option value="">Select Sub Category (Optional)</option></select><button class="btn btn-outline-primary quick-master-btn" type="button" data-master="sub_category"><i class="mdi mdi-plus"></i></button></div></div>
<div class="col-md-4"><label class="form-label">HSN</label><div class="input-group"><select class="form-select price-calc" id="hsn_id" name="hsn_id"><option value="">Select HSN (Optional)</option></select><button class="btn btn-outline-primary quick-master-btn" type="button" data-master="hsn"><i class="mdi mdi-plus"></i></button></div><small class="text-muted" id="gstAmountText">GST amount: ₹0.00</small></div>
...
<div class="col-md-3"><label class="form-label d-block">Secondary Unit</label><div class="form-check form-switch mt-2"><input class="form-check-input" type="checkbox" role="switch" id="enable_secondary_unit" name="enable_secondary_unit" value="1"><label class="form-check-label" for="enable_secondary_unit">Enable Secondary Unit</label></div><small class="text-muted">Switch ON to enter conversion</small></div>
<div class="col-md-3 secondary-unit-field d-none"><label class="form-label">Secondary Unit Label</label><select class="form-select" id="secondary_unit_label" name="secondary_unit_label" disabled><option value="">Select Secondary Unit</option><option value="Piece">Piece</option><option value="Box">Box</option><option value="Pack">Pack</option><option value="Case">Case</option><option value="Set">Set</option><option value="Dozen">Dozen</option><option value="KG">KG</option><option value="Gram">Gram</option><option value="Litre">Litre</option><option value="ML">ML</option><option value="Meter">Meter</option><option value="Feet">Feet</option><option value="Bottle">Bottle</option><option value="Number">Number</option></select></div>
