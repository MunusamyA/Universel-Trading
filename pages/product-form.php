...
<div class="col-md-3"><label class="form-label">Secondary Unit Label</label><select class="form-select" id="secondary_unit_label" name="secondary_unit_label"><option value="">Select Secondary Unit (Optional)</option><option value="Piece">Piece</option><option value="Box">Box</option><option value="Pack">Pack</option><option value="Case">Case</option><option value="Set">Set</option><option value="Dozen">Dozen</option><option value="KG">KG</option><option value="Gram">Gram</option><option value="Litre">Litre</option><option value="ML">ML</option><option value="Meter">Meter</option><option value="Feet">Feet</option><option value="Bottle">Bottle</option><option value="Number">Number</option></select></div>
<div class="col-md-3"><label class="form-label">Secondary Conversion</label><input type="number" step="0.0001" min="0.0001" class="form-control" id="secondary_unit_value" name="secondary_unit_value" value=""><small class="text-muted">Required only when secondary unit is selected</small></div>
