        ...
        <div class="modal-content">
            ...
            <form id="recordForm" autocomplete="off">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Add HSN</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control" id="cgst_percentage" name="cgst_percentage" value="0.00">
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">SGST %</label>
                            <input type="number" step="0.01" min="0" class="form-control" id="sgst_percentage" name="sgst_percentage" value="0.00">
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">IGST %</label>
                            <input type="number" step="0.01" min="0" class="form-control" id="igst_percentage" name="igst_percentage" value="0.00">
                        </div>
