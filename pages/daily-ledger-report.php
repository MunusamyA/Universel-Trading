                            ...
                            <div class="col-md-5">
                                ...
                                <div class="border rounded p-2">
                                    <div class="form-check form-check-inline mb-1">
                                        <input class="form-check-input ledger-type-check" type="checkbox" id="typeAll" value="all" checked>
                                        <label class="form-check-label" for="typeAll">All</label>
                                    </div>
                                    <div class="form-check form-check-inline mb-1">
                                        <input class="form-check-input ledger-type-check ledger-type-item" type="checkbox" id="typeSales" value="sales" checked>
                                        <label class="form-check-label" for="typeSales">Sales</label>
                                    </div>
                                    <div class="form-check form-check-inline mb-1">
                                        <input class="form-check-input ledger-type-check ledger-type-item" type="checkbox" id="typeCustomerPayment" value="customer_payment" checked>
                                        <label class="form-check-label" for="typeCustomerPayment">Customer Payment</label>
                                    </div>
                                    <div class="form-check form-check-inline mb-1">
                                        <input class="form-check-input ledger-type-check ledger-type-item" type="checkbox" id="typePurchase" value="purchase" checked>
                                        <label class="form-check-label" for="typePurchase">Purchase</label>
                                    </div>
                                    <div class="form-check form-check-inline mb-1">
                                        <input class="form-check-input ledger-type-check ledger-type-item" type="checkbox" id="typeSupplierPayment" value="supplier_payment" checked>
                                        <label class="form-check-label" for="typeSupplierPayment">Supplier Payment</label>
                                    </div>
                                    <div class="form-check form-check-inline mb-1">
                                        <input class="form-check-input ledger-type-check ledger-type-item" type="checkbox" id="typeExpense" value="expense" checked>
