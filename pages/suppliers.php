                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div>
                                <h4 class="mb-0" id="pageTitleText">Suppliers</h4>
                                <p class="text-muted mb-0 mt-1" id="pageNoteText">Loading...</p>
                            </div>

                            <div class="page-title-right">
                                <button type="button" class="btn btn-primary waves-effect waves-light d-none" id="addSupplierBtn">
                                    <i class="mdi mdi-plus me-1"></i>
                                    <span id="addSupplierBtnText">Add Supplier</span>
                                </button>
                            </div>
                        </div>
