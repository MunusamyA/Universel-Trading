...
secureSessionStart();
requireLogin();
$page_title = 'Categories | Universal ERP';
?>
<!doctype html>
<html lang="en">
...
<div class="row"><div class="col-12"><div class="page-title-box d-flex align-items-center justify-content-between"><h4 class="mb-0">Categories</h4><button type="button" class="btn btn-primary" id="addBtn"><i class="mdi mdi-plus me-1"></i> Add Category</button></div></div></div>
...
<div class="table-responsive"><table class="table table-centered table-nowrap mb-0"><thead><tr><th width="60">#</th><th>Category</th><th>Description</th><th>Status</th><th width="120">Action</th></tr></thead><tbody id="tableBody"><tr><td colspan="8" class="text-center text-muted">Loading...</td></tr></tbody></table></div>
</div></div>
...
<script>window.BASE_URL = "<?= BASE_URL; ?>"; window.MASTER_FILE = "categories";</script>
<script src="<?= BASE_URL; ?>pages-js/categories.js?v=<?= time(); ?>"></script>
</body></html>