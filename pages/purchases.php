                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <div>
                                <h4 class="mb-0" id="pageTitleText">Purchases</h4>
                                <p class="text-muted mb-0 mt-1" id="pageNoteText">Loading...</p>
                            </div>

                            <div>
                                <a href="<?= BASE_URL; ?>pages/supplier-payments.php" class="btn btn-outline-success me-2 d-none" id="supplierPaymentBtn">
                                    <i class="mdi mdi-cash-multiple me-1"></i> Supplier Payment
                                </a>

                                <a href="<?= BASE_URL; ?>pages/supplier-ledger.php" class="btn btn-outline-info me-2 d-none" id="supplierLedgerBtn">
                                    <i class="mdi mdi-book-open-page-variant me-1"></i> Supplier Ledger
                                </a>

                                <a href="<?= BASE_URL; ?>pages/purchase-form.php" class="btn btn-primary d-none" id="addPurchaseBtn">
                                    <i class="mdi mdi-plus me-1"></i>
                                    <span id="addPurchaseBtnText">Add Purchase</span>
                                </a>
                            </div>
                        </div>
            ...
            <div class="modal-body" id="purchaseViewBody">
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="card-body text-muted">
                                <h3 class="text-primary" id="totalPurchasesCount">0</h3>
                                Total Purchases
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="card-body text-muted">
                                <h3 class="text-success" id="totalAmount">0.00</h3>
                                Total Amount
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card text-center">
                            <div class="card-body text-muted">
                                <h3 class="text-info" id="paidAmount">0.00</h3>
                                Paid Amount
                            </div>
                        </div>
                    </div>
